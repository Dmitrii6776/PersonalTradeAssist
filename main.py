# 🚀 Ultimate Crypto Market and Sentiment Tracker
...
def fetch_orderbook(symbol):
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Failed to fetch orderbook for {symbol}: {response.status_code}")
            return [], []
    except Exception as e:
...
def update_data():
    ...
    print(f"[{datetime.now()}] Updating market and sentiment data...")
...
@app.route("/")
def root():
    return "Crypto Sentiment and Market API is running 🚀"
